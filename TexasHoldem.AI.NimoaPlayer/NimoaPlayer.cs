    ...
    public class NimoaPlayer : BasePlayer
    {
        ...
        public override void StartGame(StartGameContext context)
        {
            ...
            if (newEnemyName != this.enemyName)
            {
                ...
                this.enemyAccuracyPerRound[GameRoundType.PreFlop] = 0;
                this.enemyAccuracyPerRound[GameRoundType.Flop] = 0;
                this.enemyAccuracyPerRound[GameRoundType.Turn] = 0;
                this.enemyAccuracyPerRound[GameRoundType.River] = 0;
